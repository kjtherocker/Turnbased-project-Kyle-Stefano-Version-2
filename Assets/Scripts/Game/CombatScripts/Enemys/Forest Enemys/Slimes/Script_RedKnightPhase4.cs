...
public class Script_RedKnightPhase4 : Script_Creatures
{
    ...
    void Start()
    {
        ...
        Model = (GameObject)Resources.Load("Objects/Battle/Enemy/Forest/RedKnights/Knight_Phase4", typeof(GameObject));
